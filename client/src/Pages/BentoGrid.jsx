  ...
  const bentoData = [
    {
      ...
      gradient: "from-neutral-900 to-neutral-950 border-neutral-800 hover:border-orange-500/30",
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 auto-rows-min">
        {bentoData.map((item) => (
          <motion.div
            ...
            className={`rounded-3xl p-6 flex flex-col md:flex-row gap-6 justify-between bg-gradient-to-br ${item.gradient} border shadow-2xl transition-all group ${item.colSpan}`}
          >
            {/* Left/Image wrapper */}
            <div className="relative h-[180px] w-full md:w-[180px] overflow-hidden rounded-2xl border border-neutral-800 shrink-0">
              <img
                src={item.img}
            ...
            <div className="flex flex-col justify-between py-2 text-left">
              ...
              <div className="mt-4 pt-4 border-t border-neutral-900/50">
                <span className="text-xs font-semibold text-neutral-400 hover:text-white transition-colors cursor-pointer flex items-center gap-1">
