...
const AllJobs = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900 pt-28 pb-20 relative overflow-hidden">
      {/* Background glow */}
      <div className="absolute top-[10%] right-[10%] w-[500px] h-[500px] rounded-full bg-orange-100/10 blur-[120px] pointer-events-none" />

      <div className="max-w-7xl mx-auto px-6 relative z-10">
        
        {/* Header section */}
        <div className="mb-10 text-left">
          <h1 className="text-3xl font-display font-bold text-slate-900 mb-2">Find your next role</h1>
          <p className="text-slate-650 text-sm">Showing {filteredJobs.length} {filteredJobs.length === 1 ? 'job' : 'jobs'} available</p>
        </div>
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="w-full lg:w-1/4">
            <div className="bg-white p-6 rounded-3xl border border-slate-200 shadow-md sticky top-28 text-left">
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      type="text"
                      className="w-full pl-10 pr-4 py-3 rounded-xl border border-slate-200 bg-slate-50/50 text-slate-900 focus:bg-white focus:border-orange-500 outline-none transition-all text-sm placeholder:text-slate-400"
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <select
                      className="w-full pl-10 pr-4 py-3 rounded-xl border border-slate-200 bg-slate-50/50 text-slate-900 focus:bg-white focus:border-orange-500 outline-none transition-all text-sm appearance-none"
          ...
          <div className="w-full lg:w-3/4">
            {!job ? (
              ...
              <div className="bg-white rounded-3xl p-12 border border-slate-200 text-center flex flex-col items-center shadow-md">
                ...
                <p className="text-slate-655 max-w-sm text-sm">We couldn't find any jobs matching your current filters. Try adjusting your search criteria.</p>
                <button 
                  onClick={() => setFilters({ keyword: "", workType: "", location: "" })}
                  className="mt-6 text-orange-600 font-semibold hover:text-orange-700 text-sm"
                >
                  Clear all filters
                </button>
              </div>
