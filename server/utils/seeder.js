...
export const seedJobs = async () => {
  try {
    ...
    if (count === 0) {
      console.log("Database has 0 jobs. Seeding default jobs...");
      const defaultJobs = [
        {
      ...
      console.log("Database successfully seeded with default jobs.");
    }
  } catch (error) {
    console.error("Error seeding default jobs:", error);
  }
};
